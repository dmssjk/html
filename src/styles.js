...
export const S = {
  ...
  listPerson: { display: "flex", flexDirection: "column", gap: 2, minWidth: 0 },
  listSub: { fontSize: 12, opacity: 0.55, fontWeight: 500 },
  listMeta: { fontSize: 12.5, opacity: 0.6, fontWeight: 500, whiteSpace: "nowrap", marginLeft: 10 },
